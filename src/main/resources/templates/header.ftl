...
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        ...
        <div class="top-nav-profile">
            <a href="/reglogin" class="zu-top-nav-userinfo " id=":0" role="button" aria-haspopup="true" aria-activedescendant="">
                <span class="name">
                    <#if user??>
                        ${user.name}
                        <#else>
                ...
                <img class="Avatar" src="../static/images/res/da8e974dc_s.jpg" srcset="https://pic1.zhimg.com/da8e974dc_xs.jpg 2x" alt="牛客">
            ...
            <ul class="top-nav-dropdown" id="top-nav-profile-dropdown" aria-labelledby=":0">
                <li>
                    ...
                    <#else>
                        <a href="/reglogin" tabindex="-1" id=":1">
                            <i class="zg-icon zg-icon-dd-home"></i>
                            点击登录
                        </a>
                    </#if>
