...
<head>
    ...
    <script async="" src="${request.contextPath}/static/scripts/ga.js"></script>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="renderer" content="webkit">
    <meta http-equiv="X-ZA-Response-Id" content="46acde5c53db46f2806ccad726de9826">
    <title>Zhihudemo - 一个仿知乎的微型问答网站</title>
...
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        <a href="${request.contextPath}" class="zu-top-link-logo"></a>
        <div class="top-nav-profile">
            <a href="${request.contextPath}/reglogin" class="zu-top-nav-userinfo " id=":0" role="button" aria-haspopup="true" aria-activedescendant="">
                <#if user??>
                <span class="name">
                    ${user.name}
                </span>
                <img class="Avatar" src="${request.contextPath}${user.headUrl}">
                <#else>
                <span class="name">
                        点击登录
                </span>
            ...
            <ul class="top-nav-dropdown" id="top-nav-profile-dropdown" aria-labelledby=":0">
                <li>
                    <#if user??>
                        <a href="${request.contextPath}/user/${user.id}" tabindex="-1" id=":1">
                            <i class="zg-icon zg-icon-dd-home"></i>
                            我的主页
                        </a>
                    <#else>
                        <a href="${request.contextPath}/reglogin" tabindex="-1" id=":1">
                            <i class="zg-icon zg-icon-dd-home"></i>
                            点击登录
                        </a>
                    </#if>
                ...
                <li>
                    <a href="${request.contextPath}/msg/list" tabindex="-1" id=":2">
                        <i class="zg-icon zg-icon-dd-pm"></i><私信></私信>
                ...
                <li>
                    <a href="${request.contextPath}/logout" tabindex="-1" id=":4">
        ...
        <div role="search" id="zh-top-search" class="zu-top-search">
            <form method="GET" action="${request.contextPath}/search" id="zh-top-search-form" class="zu-top-search-form">
                <input type="hidden" name="type" value="content">
                <label for="q" class="hide-text">搜索</label><input type="text" class="zu-top-search-input" id="q" name="keywords" autocomplete="off" value="" placeholder="搜索你感兴趣的内容..." role="combobox" aria-autocomplete="list">
        ...
        <div id="zg-top-nav" class="zu-top-nav">
            <ul class="zu-top-nav-ul zg-clear">
                <li class="zu-top-nav-li current" id="zh-top-nav-home">
                    <a class="zu-top-nav-link" href="${request.contextPath}/index" id="zh-top-link-home" data-za-c="view_home" data-za-a="visit_home" data-za-l="top_navigation_home">首页</a>
                </li>
